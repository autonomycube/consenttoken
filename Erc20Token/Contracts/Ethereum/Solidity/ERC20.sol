...
contract ERC20 is IERC20 {
    ...
    * https://github.com/ethreum/EIPs/issues/20#issuecommit-263524729
    ...
    * @param to address The address to which you want to send tokens to
    ...
    */
    ...
    /**
    * @dev Internal function that burns an amount of the token of a given
    * account, deducting from the sender's allowance for said amount. Uses the
